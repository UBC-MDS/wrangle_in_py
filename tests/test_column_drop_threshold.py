...
#     assert column_drop_threshold(missing_copy, 0.5).shape == empty_df.shape, f"Expected shape {empty_df.shape}, but got {column_drop_threshold(missing_copy, 0.5).shape}"
